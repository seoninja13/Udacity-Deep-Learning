...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.NotebookCellManager=void 0;var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_nbpresentDeps=require("nbpresent-deps"),_namespace=require("base/js/namespace"),_namespace2=_interopRequireDefault(_namespace),_parts=require("../parts"),_base=require("./base"),NotebookCellManager=exports.NotebookCellManager=function(e){function t(){return _classCallCheck(this,t),_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).apply(this,arguments))}return _inherits(t,e),_createClass(t,[{key:"getCells",value:function(){return _namespace2.default.notebook.get_cells().reduce(function(e,t){return t.metadata.nbpresent&&(e[t.metadata.nbpresent.id]=t),e},{})}},{key:"cellId",value:function(e){try{return e.metadata.nbpresent.id}catch(e){return null}}},{key:"cellPartGeometry",value:function(){var e=this,t=this;return _namespace2.default.notebook.get_cells().map(function(r){var n=e.cellId(r),a=_nbpresentDeps.d3.entries(_parts.PART_SELECT).map(function(e){return t.getPart({cell:n,part:e.key},r.element[0]).reduce(function(t,a){var o=a[0],u=o&&o.getBoundingClientRect();return u&&u.height&&t.push({cell:{key:n,value:r},part:e.key,bb:u}),t},[])});return a})}}]),t}(_base.BaseCellManager);
